...
import { Upload, FileCode, Package, AlertCircle, CheckCircle, Loader2, Plus, X, FolderOpen, Github } from 'lucide-react';
...
function App() {
  ...
  const [firmware, setFirmware] = useState<string>('unleashed');
  ...
  const handleCompile = async () => {
    ...
    try {
      ...
      const name = mode === 'git'
        ? (gitUrl.split('/').pop()?.replace('.git', '') || 'app') + '.fap'
        : cFile!.name.replace('.c', '.fap');
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-slate-300 text-lg">Compile your Flipper Zero apps into ready-to-use .FAP files</p>
          </div>
            ...
            <div className="p-8 space-y-6">
              ...
              <button onClick={handleCompile} disabled={!canCompile || compiling}
                ...
                {compiling
                  ...
                  : mode === 'git'
                    ? <><Github className="w-5 h-5" />Clone & Compile</>
          ...
          <div className="mt-8 text-center text-slate-400 text-sm">
            Upload files or paste a GitHub URL to compile into a .FAP package
          </div>
        </div>
      </div>
    </div>
